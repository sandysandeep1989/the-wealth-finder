      ...
      <div class="srv-media-cards-grid" data-reveal-stagger>
        ...
        <div class="srv-media-card">
          ...
          <div class="srv-media-text">
            ...
            <p>Quick explanation of what struck off means and the first practical step to take for revival</p>
          </div>
        </div>
        <!-- Carousel Card -->
        <div class="srv-media-card">
          ...
          <div class="srv-media-text">
            ...
            <p>Key impacts of struck-off status and what revival can restore</p>
          </div>
        </div>
        <!-- Comic Card -->
        <div class="srv-media-card">
          ...
          <div class="srv-media-text">
            ...
            <p>From struck-off status to restoration &ndash; a visual story</p>
          </div>
        </div>
        <!-- Download Card -->
        <div class="srv-media-card">
          ...
          <div class="srv-media-text">
            <h3>Download</h3>
            <p class="srv-media-subtitle">Company Revival Eligibility &amp; Action Pack (PDF)</p>
