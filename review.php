...
<div class="review-page">
  ...
  <!-- ========== STATS BAR ========== -->
  <section class="stats" id="review-stats">
    <div class="container">
  ...
  <!-- ========== TESTIMONIALS ========== -->
  <section class="testimonials" id="review-testimonials">
    <div class="container">
     
      <div class="testimonials-grid" id="review-testimonials-grid" data-reveal-stagger>
        <!-- Row 1 -->
      ...
      <!-- Load More -->
      <div class="review-page-load-more" data-reveal="up">
        <button type="button" class="btn btn-secondary" id="review-load-more-btn">
          <span>Load More</span>
...
<script>
(function() {
  const btn = document.getElementById('review-load-more-btn');
  if (!btn) return;
  const grid = document.getElementById('review-testimonials-grid');
